...
def get_filters():
    ...
    city = input('Please choose city (chicago, new york city, washington): ')
    while(city not in ['chicago','new york city','washington']):
        city = input('Please choose city (chicago, new york city, washington): ')
        
    # TO DO: get user input for month (all, january, february, ... , june)
    month = input('Please choose month (all, january, february, ... , june): ')
    while(month not in ['all','january','february', 'march', 'april', 'may', 'june']):
        month = input('Please choose month (all, january, february, ... , june): ')

    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day = input('Please choose month (all, monday, tuesday, ... sunday): ')
...
def station_stats(df):
    ...
    print('most frequent combination of start station and end station trip: {}'.format(df['Start - End (Stations)'].mode()[0]))
